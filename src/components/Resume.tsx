...
const FullCurriculumVitae: React.FC = () => {
  return (
    <div className="min-h-screen bg-white text-black p-8 md:p-16 font-serif leading-tight">
      <div className="max-w-4xl mx-auto border border-gray-100 shadow-sm p-8 md:p-12">
        <div className="mb-6">
        ...
        <header className="text-center mb-6">
          ...
          <div className="text-[10px] md:text-xs flex flex-wrap justify-center gap-x-3 gap-y-1 text-gray-800">
